...
void startScheduler(void* callback = nullptr, void* context = nullptr);

/// Helper scheduler start with variable settings for testing.
void startScheduler(unsigned long int timeout, size_t interval, void* callback = nullptr, void* context = nullptr);
}
